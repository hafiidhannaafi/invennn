        ...
        <div class="col-lg-12">
          ...
          <div class="card">
            <div class="card-body">
              ...
              <form action="{{ route('inputbarangkeluar') }}" method="POST" enctype="multipart/form-data" class=" needs-validation" novalidate>
                @csrf
                {{-- <div class="row mb-3">
                ...
                <div class="row mb-3">
                  ...
                  <div class="col-sm-10">
                    <input type="date" id="validationTooltip05"  name="tanggal_keluar" class="form-control"  required>
                    <div class="invalid-feedback">
                      Harus di isi
                    </div>
                  </div>
                ...
                <div class="row mb-3">
                  ...
                  <div class="col-sm-10">
                    <input type="text" id="validationTooltip04"  name="jumlah_keluar" class="form-control"  required>
                    <div class="invalid-feedback">
                      Harus di isi
                    </div>
                  </div>
